# Talponia Chat
This is a chatroom for pawpaw peduncle borers _(Talponia plummeriana)_, a moth species that feeds and lives on pawpaw trees, the trees of the largest fruit native to North America. Peduncles enter their name, date the egg they hatched from was born and their message which is displayed at the location of their click on the page. 

## How to run Locally
-Clone the talponia-chat repository to your local enviornment
-Open the repo in VScode
-Open index.html and use the Go Live feature in VScode to view project
